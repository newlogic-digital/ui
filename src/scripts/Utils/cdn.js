export default {
    ...
    datepicker: 'https://cdn.jsdelivr.net/npm/vanillajs-datepicker@1.3.1/dist/css/datepicker.min.css',
    datepickerLang: 'https://cdn.jsdelivr.net/npm/vanillajs-datepicker@1.3.1/js/i18n/locales/{lang}.min.js'
}
